...
- [x] Una célula viva con dos vecinas verticales vive.
  - [x] columna 1
  - [x] columna 2
  - [x] columna 3
- [x] Una célula viva con dos vecinas horizontales vive.
  - [X] fila 1
  - [X] fila 2
  - [X] fila 3
...
- [x] Oscilador horizontal (Una célula viva con tres vecinas vive.)

## Comportamiento 3
Cualquier célula viva con más de tres vecinas vivas muere, como por sobrepoblación.

- [x] Una célula viva con 4 vecinas muere
- [ ] Una célula viva con más de 4 vecinas muere

## Comportamiento 4
Cualquier célula muerta con exactamente tres vecinas vivas se convierte en una célula viva, como por reproducción.

- [x] Una celula muerta con 3 vecinas vivas, vuelve a vivir
